            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div className='text-center'>
                  ...
                  <p>A game designed for musicians to improve their auditory recognition</p><a href="https://ear-elevation-ni65itt2f-bradpk.vercel.app/" target='_blank'>
                    <Image className={styles.test} src='/ear-elevation.png' width={460} height={300} alt="project screenshot"></Image></a><br></br>
              ...
              <div class="carousel-item">
                <div className='text-center'>
                  ...
                  <p>A synthesizer with controls for oscillator selection and envelope settings</p><a href="https://synth-pi.vercel.app/piano/" target='_blank'>
                    <Image src='/synth.png' width={460} height={300} alt="project screenshot"></Image></a><br></br>
              ...
              <div class="carousel-item">
                <div className='text-center'>
                  ...
                  <p>A basic calculator created with the asp.net core framework</p><a href="https://dotnet-calculator.azurewebsites.net/" target='_blank'>
              ...
              <div class="carousel-item">
                <div className='text-center'>
                  ...
                  <p>A to-do list, because you keep forgetting that you need onions from Kroger </p><a href="https://bradpk.github.io/to-do-list//" target='_blank'>
                    <Image src='/todo.png' width={460} height={300} alt="project screenshot"></Image></a><br></br>
              ...
              <div class="carousel-item">
                <div className='text-center'>
                  ...
                  <p>A weather app that allows you to fetch weather data from a given zip code</p><a href="https://bradpk.github.io/weather-app//" target='_blank'>
                    <Image src='/weatherapp.png' width={460} height={300} alt="project screenshot"></Image></a><br></br>
              ...
              <div class="carousel-item">
                <div className='text-center'>
                  ...
                  <p>A mock restaurant website created to practice making HTTP requests</p><a href="https://bradpk.github.io/React-Restaurant-/#/" target='_blank'>
                    <Image src='/bistro.png' width={460} height={300} alt="project screenshot"></Image></a><br></br>
              ...
              <div class="carousel-item">
                <div className='text-center'>
                  ...
                  <p>An alarm clock to get you up and at 'em. Whats the magic button do?</p><a href="https://bradpk.github.io/alarm-clock/" target='_blank'>
                    <Image src='/alarmclock.png' width={460} height={300} alt="project screenshot"></Image></a><br></br>
              ...
              <div class="carousel-item">
                <div className='text-center'>
                  ...
                  <p>A random story generator with options for names and measurements</p><a href="https://bradpk.github.io/silly-story-generator/" target='_blank'>
                    <Image src='/story.png' width={460} height={300} alt="project screenshot"></Image></a><br></br>
              ...
              <div class="carousel-item">
                <div className='text-center'>
                  ...
                  <p>A project that guesses the number you picked in your head, whoa..</p><a href="https://bradpk.github.io/mind-reader/" target='_blank'>
                    <Image src='/mindreader.png' width={460} height={300} alt="project screenshot"></Image></a><br></br>
