          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div className='justify-content-center text-center'>
                ...
                <p class="description">A game designed for musicians to improve their auditory recognition</p><a href="https://ear-elevation-ni65itt2f-bradpk.vercel.app/" target='_blank'>
                  <Image src='/ear-elevation.png' width={450} height={300} alt="img"></Image></a>
            ...
            <div class="carousel-item">
              <div className='justify-content-center text-center'>
                ...
                <p class="description">A virtual musical synthesizer with controls for oscillator selection and envelope settings</p><a href="https://ear-elevation-ni65itt2f-bradpk.vercel.app/" target='_blank'>
                  <Image src='/ear-elevation.png' width={450} height={300} alt="img"></Image></a>
                <a href="https://github.com/Bradpk/Ear_Elevation_Front_Two"><br></br><br></br>Github Repo</a>
              </div>
            </div>
            <div class="carousel-item">
              <div className='justify-content-center text-center'>
                ...
                <p class="description">A rendition of the classic game Tic-Tac-Toe
                  Give it a go!</p><a href="https://ear-elevation-ni65itt2f-bradpk.vercel.app/" target='_blank'>
                  <Image src='/ear-elevation.png' width={450} height={300} alt="img"></Image></a>
                <a href="https://github.com/Bradpk/Ear_Elevation_Front_Two"><br></br><br></br>Github Repo</a>
              </div>
            </div>
            <div class="carousel-item">
              <div className='justify-content-center text-center'>
                <h1>TO DO LIST</h1>
                <p class="description">A to-do list, because you keep forgetting that you need onions from Kroger </p><a href="https://ear-elevation-ni65itt2f-bradpk.vercel.app/" target='_blank'>
                  <Image src='/ear-elevation.png' width={450} height={300} alt="img"></Image></a>
                <a href="https://github.com/Bradpk/Ear_Elevation_Front_Two"><br></br><br></br>Github Repo</a>
              </div>
            </div>
            <div class="carousel-item">
              <div className='justify-content-center text-center'>
                <h1>WEATHER APP</h1>
                <p class="description">A weather app that allows you to fetch weather information from a given zip code</p><a href="https://ear-elevation-ni65itt2f-bradpk.vercel.app/" target='_blank'>
                  <Image src='/ear-elevation.png' width={450} height={300} alt="img"></Image></a>
                <a href="https://github.com/Bradpk/Ear_Elevation_Front_Two"><br></br><br></br>Github Repo</a>
              </div>
            </div>
            ...
            <div class="carousel-item">
              <div className='justify-content-center text-center'>
                <h1>ALARM CLOCK</h1>
                <p class="description">An alarm clock designed to get you up and at 'em. But whats the magic button do?</p><a href="https://ear-elevation-ni65itt2f-bradpk.vercel.app/" target='_blank'>
                  <Image src='/ear-elevation.png' width={450} height={300} alt="img"></Image></a>
                <a href="https://github.com/Bradpk/Ear_Elevation_Front_Two"><br></br><br></br>Github Repo</a>
              </div>
            </div>
